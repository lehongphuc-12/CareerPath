      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 lg:px-12 py-12 relative overflow-y-auto">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-4 px-6 border-2 border-slate-100 dark:border-slate-800 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all font-bold text-sm"
            >
